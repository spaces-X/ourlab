 ...
 * 日期粒度：月
 * */
case class Data(time:String,vtype:String,cash:Double)
...
//    outfile.repartition(1).sortByKey(ascending, numPartitions)
    ...
    }.saveAsTextFile("hdfs://bigdata01:9000/home/guizhou/cash/Cash_monthvtype_bytype")
